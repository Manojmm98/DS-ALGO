...
public class Main {
   ...
   public static void main(String[] args) throws Exception {
      ...
      hPath(graph,src,new HashMap<>(),src+"");
   }
   ...
   public static void hPath(ArrayList<Edge> graph[],int vtx,HashMap<Integer,Boolean> visited,String psf){
       ...
       for(Edge e : graph[vtx]){
           if(visited.containsKey(e.nbr)==false){
               hPath(graph,e.nbr,visited,psf+e.nbr);
           }
       }
       visited.remove(vtx);
